    ...
    <div className="flex justify-center items-center mt-20 mx-auto">
        <div className="w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md">
            ...
            <form className="space-y-4 " onSubmit={handleLogin}>
                ...
                <input type="email" className="w-full px-3 py-2 mt-1 border border-gray-500 rounded-md
                 bg-transparent text-white focus:outline-none focus:ring" placeholder="you@email.com" id="email" value={email} onChange={(e) => setEmail(e.target.value)} />
                ...
                <input type="password" className="w-full px-3 py-2 mt-1 border border-gray-500 rounded-md
