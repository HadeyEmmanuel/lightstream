  ...
  return (
    <div className="hero-bg relative">
        <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-8'>
            <Link to={"/"} className="font-semibold text-4xl text-purple-700">LightStream</Link>
            <Link to={"/login"} className='text-white bg-purple-700 py-1 px-2 rounded'>
                Sign In
            </Link>
        </header>
        ...
        <div className='flex flex-col items-center justify-center text-center py-10 text-white max-w-6xl mx-auto'>
            ...
            <form className='flex flex-col md:flex-row gap-2 w-1/2 mb-10' onSubmit={handleFormSubmit}>
                <input
                    type='email'
                ...
                />
                <button className='bg-theme text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
                    Get Started
                ...
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative'>
                        <div className='relative h-1/2'>
                            <img src='/warroom.jpg' alt='War Room img' className='mt-4 h-1/2' />
                            ...
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
                                <img src='/warroom2.jpg' alt='image' className='h-full' />
